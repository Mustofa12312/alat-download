...
pub async fn add_to_queue(
    ...
    Ok(CommandResponse {
        success: true,
        data: None,
        message: Some(format!("Added {} to queue", id)),
    })
}
...
pub async fn remove_from_queue(
    ...
    Ok(CommandResponse {
        success: true,
        data: None,
        message: Some(format!("Removed {} from queue", id)),
    })
}
...
pub async fn reorder_queue(
    ...
    Ok(CommandResponse {
        success: true,
        data: None,
        message: Some(format!("Reordered queue item {} to {}", id, new_index)),
    })
}
...
pub async fn clear_queue(pool: State<'_, SqlitePool>) -> Result<CommandResponse<String>, String> {
    Ok(CommandResponse {
        success: true,
        data: None,
        message: Some("Cleared queue".into()),
    })
}
...
pub async fn start_queue(pool: State<'_, SqlitePool>) -> Result<CommandResponse<String>, String> {
    Ok(CommandResponse {
        success: true,
        data: None,
        message: Some("Started queue".into()),
    })
}
...
pub async fn pause_queue(pool: State<'_, SqlitePool>) -> Result<CommandResponse<String>, String> {
    Ok(CommandResponse {
        success: true,
        data: None,
        message: Some("Paused queue".into()),
    })
}
